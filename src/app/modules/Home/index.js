...
import { createAction, createActionName, setOK, setFail } from "../../helpers";
import { query as queryCalendarEvents } from "../../api/calendar-events";
import { query as queryRoomAvailability } from "../../api/room-availability";
...
function* homeListeners({ takeEvery, takeLatest }) {
    yield takeEvery(FETCH_AVAILABILITY, apiSaga, queryRoomAvailability);
    yield takeEvery(FETCH_CALENDAR_EVENTS, apiSaga, queryCalendarEvents);
}
